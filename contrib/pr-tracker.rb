# Draft formula for wmxscott/homebrew-tap. Fill in url and sha256 once v1.2.1 is tagged:
#   curl -sL https://github.com/wmxscott/pr-tracker/archive/refs/tags/v1.2.1.tar.gz | shasum -a 256
